...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TCBFreshchatBotWidget.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Neil Francis Ramirez Hipona/TCBFreshchatBotWidget'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Neil Francis Ramirez Hipona' => 'nferocious76@gmail.com' }
  s.source           = { :git => 'https://github.com/Neil Francis Ramirez Hipona/TCBFreshchatBotWidget.git', :tag => s.version.to_s }
